...
# Connect Timeout-->response and data code changed,DNS of browser(google),Firewall(python,pycharm)private allowed
...
# AS similarity.pkl is of 180 MB size, opened it from Google Drive
if not os.path.exists("similarity.pkl"):
    url = "https://drive.google.com/uc?id=1Ti-G6EIiPlQ5zdolzIgEfMPHRyBhDZeF"
